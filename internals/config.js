...
const kelsonic = {
  ...
  dllPlugin: {
    ...
    entry(pkg) {
      ...
      const exclude = pkg.dllPlugin.exclude || kelsonic.dllPlugin.defaults.exclude;
      const include = pkg.dllPlugin.include || kelsonic.dllPlugin.defaults.include;
